 ...
 *   - SQLite database file at JPATH_ROOT . '/media/com_clubleadership/data/clubleadership.db'
 ...
 */
abstract class ClubLeadershipStoreBackend
{
    /**
 ...
 * SQLite backend.
 */
class ClubLeadershipStoreSqlite extends ClubLeadershipStoreBackend
{
    private $pdo;
 ...
 */
class ClubLeadershipStoreJson extends ClubLeadershipStoreBackend
{
    private $file;
...
class ClubLeadershipStore
{
     ...
     * Singleton accessor.
     *
     * @return ClubLeadershipStoreBackend
     */
    public static function getInstance()
    {
        if (self::$instance === null) {
            $dataDir = JPATH_ROOT . '/media/com_clubleadership/data';

            if (extension_loaded('pdo_sqlite')) {
                try {
                    self::$instance = new ClubLeadershipStoreSqlite($dataDir . '/clubleadership.db');
            ...
            self::$instance = new ClubLeadershipStoreJson($dataDir . '/clubleadership.json');
        }
