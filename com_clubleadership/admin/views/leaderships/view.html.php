...
class ClubLeadershipViewLeaderships extends HtmlView
{
    protected $items;
    ...
    public function display($tpl = null)
    {
        ...
        ClubLeadershipHelper::addSubmenu('leaderships');
        $this->addToolbar();
    ...
    {
        $canDo = ClubLeadershipHelper::getActions();

        ToolbarHelper::title(Text::_('COM_CLUBLEADERSHIP_MENU_LEADERSHIP'), 'users');
        ...
        if ($canDo->get('core.admin')) {
            ToolbarHelper::preferences('com_clubleadership');
        }
    }
}
