...
class ClubLeadershipModelLeaderships
{
    private $store;
    ...
    {
        return ClubLeadershipHelper::getTypeOptions();
    }

    public function getPublishedOptions()
    {
        return ClubLeadershipHelper::getPublishedOptions();
    }

    public function getStatusOptions()
    {
        return ClubLeadershipHelper::getStatusOptions();
    }

    public function getBackendName()
    {
        return ClubLeadershipStore::backendName();
    }
}
