...
$contactHiddenText   = $paramsData->get('contact_hidden_text', Text::_('MOD_CLUBLEADERSHIP_LOGIN_TO_VIEW'));

$rawData = ModClubLeadershipHelper::getLeadership();

require ModuleHelper::getLayoutPath('mod_clubleadership', $paramsData->get('layout', 'default'));
