...
SET `location` = 'https://github.com/jaydenrussell/club-leadership-directory/releases/latest/download/update.xml',
    `enabled` = 1
...
SELECT 'Club Leadership Directory Update', 'extension',
       'https://github.com/jaydenrussell/club-leadership-directory/releases/latest/download/update.xml', 1, 0, ''
FROM DUAL
WHERE NOT EXISTS (
